...
Having a different VM means that we must have a separate compiler [zk-solc](https://github.com/tidalchain/zksolc-bin) -
...
[hardhat plugins](https://github.com/tidalchain/hardhat-micro) ), it brings a bunch of benefits too: for example it
...
<https://github.com/tidalchain/micro-system-contracts>.
