...
1. checkout if the circuit geometry has changed in the new version of the circuit by running the
   [workflow](https://github.com/tidalchain/zkevm_test_harness/actions/workflows/geometry-config-generator.yml) in
...
3. prepare an PR with the updated dependencies [sample PR](https://github.com/tidalchain/micro-2-dev/pull/2481).
4. Run the verification key [workflow](https://github.com/tidalchain/micro/actions/workflows/fri-vk-generator.yaml)
...
6. Run the cpu setup data generation
   [workflow](https://github.com/tidalchain/micro/actions/workflows/fri-setup-data-generator.yml) against the PR to
   generate the cpu setup data.
7. Run the gpu setup data generation
   [workflow](https://github.com/tidalchain/micro/actions/workflows/fri-gpu-setup-data-generator.yml) against the PR to
   generate the gpu setup data.
...
9. Run the GPU integration test
   [workflow](https://github.com/tidalchain/micro/actions/workflows/fri-gpu-prover-integration-test.yml) against the PR
   to verify the GPU prover is working fine with new circuits.
